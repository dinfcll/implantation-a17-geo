...
export class aProposComponent implements OnInit {
    ...
    constructor() {
        ...
        this.histoirePersonnage = ["Annie, nienie ou bloody Annie est une petite souris qui mange des biscuits dans son lit. Annie c'est la personne la moins gênée au monde et s’en ai quasiment inspirant. Elle a su craquer la carapace des plus dur. Annie est une très bonne joueuse d’équipe, elle a à cœur la réussite du projet, mais elle accorde plus d’importance aux membres de l’équipe. C’est maman Annie. Aussi, elle n’a pas peur de dire ce qu’elle pense ! Si tu la fais chier , tu vas le savoir assez vite et c’est parfait comme ça. C’est l’âme et le cœur de l’équipe.",
        ...
        "Wizard horse (Pascal) fut anciennement un mage de l'électronique passionné par la réparation et l'entretien des machines. Malheureusement, les gens délaissèrent peu à peu la magie réparatrice d'appareils électroniques au profit de la nouveauté et il ne put pas percer dans le domaine du a l'arrivée de nouvelles magies extravagantes... Néanmoins, après quelque temps, il se recycla en mage de l'informatique! Une force renaquit en lui, retrouvant un nouveau dessein à sa vie! Aujourd'hui, Wizard Horse est maitre dans l'art d'aider les autres. Il vit d'amour de ses pairs, de code et... de Pepsi! On ne peut pas se passer de lui!",
        "Jérôme, c'est le coéquipier motivé qui participe a tous les projets du début à la fin sans relâche et sans jamais se décourage. Si chaque projet qu'on a remis en équipe avec lui a été ce qu'il est, c'est parce qu'il était là. Jérôme, c'est quelqu'un qui sait travailler en équipe, quelqu'un d'honnête qui n'a pas peur de donner son opinion et quelqu'un qui sait ce qu'il veut dans la vie. Et Jérôme, c'est aussi quelqu'un de super compétitif super drôle a regarder jouer a un jeu (quand tu n'es pas dans l'équipe oppose)! «Pick your side well newb!»"];
